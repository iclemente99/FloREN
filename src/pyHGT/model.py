...
class GNN(nn.Module):
    def __init__(self, in_dim, n_hid, num_types, num_relations, n_heads, n_layers, n_labels, dropout = 0.2, conv_name = 'hgt', prev_norm = True, last_norm = True, use_RTE = True, use_grad_checkpoint = False):
    ...
    def forward_one(self, node_feature, node_type, edge_time, edge_index, edge_type):
        ...
        for gc in self.gcs:
            if self.use_grad_checkpoint:
                meta_xs = grad_checkpoint(gc, meta_xs, node_type, edge_index, edge_type, edge_time, use_reentrant=False)
            else:
    ...
    def forward(self, node_feature_0, node_type_0, edge_time_0, edge_index_0, edge_type_0, node_feature_1, node_type_1, edge_time_1, edge_index_1, edge_type_1, node_feature_2, node_type_2, edge_time_2, edge_index_2, edge_type_2):
        meta_xs_1, att_1 = self.forward_one(node_feature_1, node_type_1, edge_time_1, edge_index_1, edge_type_1)
        meta_xs_2, att_2 = self.forward_one(node_feature_2, node_type_2, edge_time_2, edge_index_2, edge_type_2)
